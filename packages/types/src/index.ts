...
export type GetMeQuery = { __typename?: 'Query', me: { __typename?: 'UserType', id: string, email: string, firstName?: string | null, lastName?: string | null, currentOrganizationId?: string | null, createdAt: string, organizations: Array<{ __typename?: 'OrganizationMemberType', organizationId: string, role: string, organization?: { __typename?: 'OrganizationType', id: string, name: string, slug: string } | null }> } };
