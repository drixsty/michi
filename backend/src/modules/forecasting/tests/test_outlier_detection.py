"""
Tests unitaires — Outlier Detection IQR (US 2.2)
...
from src.modules.forecasting.algorithms.outlier_detection import (
    detect_outliers,
...
class TestDetectOutliers:
    ...
    def test_rolling_window_constant(self):
        """La fenêtre IQR de correction est bien 7 jours."""
        assert OUTLIER_ROLLING_WINDOW == 7
...
class TestDetectOutliersBatch:
    ...
    def test_batch_processes_multiple_products(self):
        ...
        # Chaque produit a au moins 1 outlier
        for pid in ["p1", "p2"]:
