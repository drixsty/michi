          ...
          {activeTab === 'security' && (
            <div className="space-y-6 animate-in fade-in duration-300">
              ...
              <section className="bg-white rounded-lg border border-border shadow-sm overflow-hidden">
                ...
                <div className="p-5">
                  <div className="flex items-center justify-between p-4 rounded-lg border border-slate-100 bg-slate-50/30 hover:border-primary/20 transition-all group">
                    <div className="flex items-center gap-4">
                      <div className="w-11 h-11 rounded-lg bg-white flex items-center justify-center border border-slate-200 shadow-sm group-hover:scale-105 transition-transform">
                    ...
                    {data?.me?.googleId ? (
                      <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-emerald-50 text-emerald-600 border border-emerald-100 shadow-sm">
                        <CheckCircle2 className="h-3.5 w-3.5" />
                        <span className="text-[10px] font-bold tracking-tight">Compte lié</span>
                      </div>
                    ) : (
                      <div className="relative group/btn scale-90 origin-right">
                         <GoogleLogin 
                           onSuccess={() => {
